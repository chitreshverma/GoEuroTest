Goal
====
Produce a simple console application to complement the supplied assignment.

Build and Run the project
--------------
Import the java project to the Eclipse IDE using maven
Right Click  and run the project as application
